...
| `.gitea/workflows/pr-governance.yml` | PR gate: Spectral lint → Microcks contract test → KrakenD gateway deploy. |
...
3. Gitea Actions runs `pr-governance.yml`, three gates in order (each gated by
